...
export const Navbar = () => {
    ...
    const onSaveJSON = () => {
        ...
        onDownload(blob, `document.json`) // !!use document name here!!!
    };
    ...
    const onSaveHTML = () => {
        ...
        onDownload(blob, `document.html`) // !!use document name here!!!
    };
    ...
    const onSaveText = () => {
        ...
        onDownload(blob, `document.txt`) // !!use document name here!!!
    };
